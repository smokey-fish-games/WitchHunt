...
public class LevelGeneratorSP : MonoBehaviour
{
    ...
    public BuildingSP[] buildings;
    public GameObject npcPrefab;
    public List<NPCControllerSP> allNPCS = new List<NPCControllerSP>();
    ...
    void Awake()
    {
        ...
        buildings = FindObjectsOfType<BuildingSP>();
    ...
    public void GenerateNPCS()
    {
        ...
        {
            List<NPCControllerSP> occupants = new List<NPCControllerSP>();
            // Family or no?
            ...
            if (sof < CHANCE_SINGLE)
            {
                ...
                NPCControllerSP meGONPC = meGO.GetComponent<NPCControllerSP>();
                if (meGONPC == null)
                {
                    RL.writeError("NOOOOOOOOO NPC Prefab has wrong NPCCONTROLLER COMPIIT");
                    throw new System.Exception("NPC prefab for level generator does not have a NPCControllerSP component");
                }
            ...
            else
            {
                ...
                NPCControllerSP manGONPC = manGO.GetComponent<NPCControllerSP>();
                if (manGONPC == null)
                {
                    RL.writeError("NOOOOOOOOO NPC Prefab has wrong NPCCONTROLLER COMPIIT");
                    throw new System.Exception("NPC prefab for level generator does not have a NPCControllerSP component");
                ...
                NPCControllerSP womGONPC = womGO.GetComponent<NPCControllerSP>();
                ...
                if (sof < CHANCE_CHILD)
                {
                    ...
                    NPCControllerSP childGONPC = childGO.GetComponent<NPCControllerSP>();
